"""v26_opts_evolve — v22 options DNA with structure upgrade from ablation.

WHY v22 won: options leverage + hunt bag IONQ/AVGO/HOOD/MU + ~10% premium risk +
high-WR selective equity SIDE (v21) + multi-name concurrent + DD floors.

WHAT failed when we "improved" naively: volume gates, single-position concentration,
underlying hard stops, streak downsizing — all cut capacity and FULL-WINDOW return.

WHAT beat v22 on same data (2024-08..2026-07): keep v22 engine, set dte_days=14
(atm10_14 style) — shorter DTE, same risk_pct 0.10.
  v22 (21 DTE): +59.8% DD -11.2% Sharpe 1.28 n=22 WR 82%
  v26 (14 DTE): +64.5% DD -9.3%  Sharpe 1.40 n=22 WR 82%
"""
