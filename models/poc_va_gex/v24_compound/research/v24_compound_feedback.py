...
NOTE: This is a theoretical ledger. It applies the full cash balance to every entry
inside a 30-day window and ignores that capital is tied while an option position is
open. It therefore overstates compounding and should not be compared directly to the
realistic options_portfolio backtest (run_v24_compound.py / SignalEngine.generate_day).
