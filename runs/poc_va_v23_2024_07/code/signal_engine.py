...
class SignalEngine:
    """v23_devin_overlay: v20b + volume-z + sector/QQQ RS conviction overlay + time/risk exits."""
        ...
        for i in range(len(data)):
            ...
            if not in_pos:
                if bool(long_entry.iloc[i]):
                    ...
                    # Conviction overlay: small boost for vol_z alignment
                    boost = _volume_z_boost(float(vol_z.iloc[i]))
