...
COMMON_WORDS: set[str] = {
    ...
    "KEY", "LINK", "PM", "TV", "HOME", "ABOUT", "BACK", "DARK", "LIGHT", "SEARCH", "TOOLS",
    "QUOTES", "FUTURE", "FOREX", "CURRENCY", "MARGIN", "TFSA", "RRSP", "ACCOUNTS", "PRICING",
    "COMMUNITY", "LEARN", "GUIDES", "PROMOTIONS", "CAREERS", "SECURITY", "PRIVACY", "DOWNLOAD",
    "DESKTOP", "MOBILE", "LOGIN", "SIGN", "SIGNUP", "SIGNIN", "ALL", "TAX", "SEASON", "INVEST",
}
